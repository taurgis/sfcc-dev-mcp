  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        guideName: {
          type: 'string',
          enum: ['cartridge_creation', 'isml_templates', 'job_framework', 'ocapi_hooks', 'scapi_hooks', 'sfra_controllers', 'sfra_models', 'scapi_custom_endpoint', 'performance', 'security'],
          description: 'The guide name (e.g., \'cartridge_creation\', \'isml_templates\', \'job_framework\', \'ocapi_hooks\', \'scapi_hooks\', \'sfra_controllers\', \'sfra_models\', \'scapi_custom_endpoint\', \'performance\', \'security\')',
        },
      },
      required: ['guideName'],
    },
