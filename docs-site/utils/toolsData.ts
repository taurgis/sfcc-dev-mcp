...
export const tools: ToolMeta[] = [
  ...
  // Cartridge Generation
  { id: 'generate-cartridge-structure', name: 'generate_cartridge_structure', category: 'Cartridge Generation', mode: 'both', description: 'Generate cartridge directory structure.', params: [p('cartridgeName','Name of cartridge'), p('targetPath','Target path (optional)', false), p('fullProjectSetup','Create full project scaffolding (boolean, default: true)', false)], examples: ['Generate cartridge named plugin_demo'], tags: ['scaffold'], popular: true },

  // Log Analysis (Full Mode)
  { id: 'get-latest-error', name: 'get_latest_error', category: 'Log Analysis', mode: 'full', description: 'Fetch latest error log entries.', params: [p('date','YYYYMMDD (default: today)', false), p('limit','Max entries (default: 20)', false)], examples: ['Show last 5 error log entries'], tags: ['logs','errors'], popular: true },
  { id: 'get-latest-warn', name: 'get_latest_warn', category: 'Log Analysis', mode: 'full', description: 'Fetch latest warn log entries.', params: [p('date','YYYYMMDD (default: today)', false), p('limit','Max entries (default: 20)', false)] },
  { id: 'get-latest-info', name: 'get_latest_info', category: 'Log Analysis', mode: 'full', description: 'Fetch latest info log entries.', params: [p('date','YYYYMMDD (default: today)', false), p('limit','Max entries (default: 20)', false)] },
  { id: 'get-latest-debug', name: 'get_latest_debug', category: 'Log Analysis', mode: 'full', description: 'Fetch latest debug log entries.', params: [p('date','YYYYMMDD (default: today)', false), p('limit','Max entries (default: 20)', false)] },
  { id: 'search-logs', name: 'search_logs', category: 'Log Analysis', mode: 'full', description: 'Search across logs for a pattern.', params: [p('pattern','Search string'), p('date','YYYYMMDD (default: today)', false), p('limit','Max entries (default: 20)', false), p('logLevel','error|warn|info|debug', false)], examples: ['Search logs for OCAPI 500 errors'], tags: ['search'] },
  { id: 'summarize-logs', name: 'summarize_logs', category: 'Log Analysis', mode: 'full', description: 'High level log activity summary.', params: [p('date','YYYYMMDD (default: today)', false)], examples: ['Summarize today\'s logs'] },
  ...
  { id: 'search-site-preferences', name: 'search_site_preferences', category: 'System Objects', mode: 'full', description: 'Search site preferences within a group.', params: [p('groupId','Preference group ID'), p('instanceType','sandbox|development|staging|production (default: sandbox)'), p('searchRequest','Search request body'), p('options','Optional search options (maskPasswords, expand)', false)], examples: ['Search site preferences in SitePreferencesMarketing group'] },
  ...
  // Script Debugger
  {
    ...
    params: [
      ...
      p('breakpointLine', 'Specific line for single breakpoint (default: lines 1-50)', false)
    ],
    examples: [
