...
const TroubleshootingPage: React.FC = () => {
    ...
    return (
        <div className="max-w-6xl mx-auto px-6 py-12">
            ...
            <p className="mt-2 text-[11px] uppercase tracking-wide text-gray-400">Surface: <strong>39 tools</strong> (docs, SFRA, ISML, agent instructions, cartridge gen, runtime logs, job logs, system & custom objects, site preferences, code versions, script debugger)</p>
