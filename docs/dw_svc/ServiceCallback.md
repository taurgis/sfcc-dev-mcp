...
**Description:** Creates a protocol-specific client object. This does not normally need to be implemented, except in the case of SOAP services. It may also be used for HTTP services to override the default configuration. Example SOAP service: initServiceClient: function( svc ) { return webreferences2.MyWSDL.getDefaultService(); } Example configuration override for an HTTP service: initServiceClient: function( svc ) { return { allowHTTP2: true }; }
